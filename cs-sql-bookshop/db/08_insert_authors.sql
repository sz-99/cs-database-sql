...
ALTER TABLE Authors
ALTER COLUMN FunFact NVARCHAR(MAX);
GO



INSERT INTO Authors(AuthorName, FunFact)
VALUES
...
('Neil Hughes', 'Neil runs the Java and C# programmes at Northcoders, but used to make his living by talking publicly about custard and writing books about magical shops. He once shamelessly inserted himself into a list of very famous authors for a database practice exercise.'),
